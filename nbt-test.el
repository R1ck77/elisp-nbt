...
(defconst big-result
  (nbt-compound :value (list
                        ...
                        (nbt-list :value (list (nbt-long :value "11" :name nil)
                                               (nbt-long :value "12" :name nil)
                                               (nbt-long :value "13" :name nil)
                                               (nbt-long :value "14" :name nil)
                                               (nbt-long :value "15" :name nil))
                                  :name "listTest (long)")
